...
import '../../clean_architectures/domain/usecase/setting/setting_usecase.dart'
    as _i25;
import '../../mvvm/data/remote/auth/auth_api.dart' as _i31;
import '../../mvvm/data/remote/plan/plan_api.dart' as _i19;
...
import '../../mvvm/repo/plan_repositories.dart' as _i21;
...
import '../../mvvm/repo/repo_impl/plan_repositories_impl.dart' as _i22;
import '../../mvvm/repo/repo_impl/session_repositories_impl.dart' as _i24;
import '../../mvvm/repo/session_repositories.dart' as _i23;
import '../../mvvm/ui/auth/view_model/sign_in/sign_in_view_model.dart' as _i26;
import '../../mvvm/ui/auth/view_model/sign_up/sign_up_view_model.dart' as _i27;
...
import '../../mvvm/ui/notification/view_model/notification_view_model.dart'
    as _i17;
import '../../mvvm/ui/overview/view_model/overview_view_model.dart' as _i18;
...
import '../../mvvm/ui/plan_overview/view_model/view_more/view_more_plan_view_model.dart'
    as _i29;
import '../../mvvm/ui/splash/view_model/splash_view_model.dart' as _i28;
import '../../mvvm/ui/wo_trac/view_model/wo_trac_view_model.dart' as _i30;
...
_i1.GetIt init(
  ...
  gh.factory<_i17.NotificationViewModel>(
      () => _i17.NotificationViewModel(gh<_i17.NotificationState>()));
  gh.factory<_i18.OverviewViewModel>(() => _i18.OverviewViewModel());
  gh.factory<_i19.PlanApi>(() => _i19.PlanApi(gh<_i11.Dio>()));
  gh.factory<_i20.PlanOverViewViewModel>(() => _i20.PlanOverViewViewModel());
  gh.factory<_i21.PlanRepositories>(
      () => _i22.PlanRepositoriesImpl(gh<_i19.PlanApi>()));
  gh.factory<_i23.SessionRepositories>(() => _i24.SessionRepositoriesImpl());
  gh.factory<_i25.SettingUseCase>(() => _i25.SettingUseCase());
  gh.factory<_i26.SignInViewModel>(() => _i26.SignInViewModel());
  gh.factory<_i27.SignUpViewModel>(() => _i27.SignUpViewModel());
  gh.factory<_i28.SplashViewModel>(() => _i28.SplashViewModel());
  gh.factory<_i29.ViewMorePlanViewModel>(() => _i29.ViewMorePlanViewModel());
  gh.factory<_i30.WooTrackViewModel>(() => _i30.WooTrackViewModel());
  gh.factory<_i31.AuthApi>(() => _i31.AuthApi(gh<_i11.Dio>()));
  gh.factory<_i32.SettingBloc>(
      () => _i32.SettingBloc(gh<_i25.SettingUseCase>()));
  return getIt;
}
