...
class _ChatThreadApi implements ChatThreadApi {
  _ChatThreadApi(
    this._dio, {
    this.baseUrl,
  });
  ...
  @override
  Future<HttpResponse<ChatThreadModel>> getThreadById(String id) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final Map<String, dynamic>? _data = null;
  ...
  @override
  Future<HttpResponse<dynamic>> deleteThread(String id) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final Map<String, dynamic>? _data = null;
