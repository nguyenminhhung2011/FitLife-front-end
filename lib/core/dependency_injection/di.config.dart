...
import '../../clean_architectures/domain/usecase/setting/setting_usecase.dart'
    as _i31;
import '../../mvvm/data/remote/auth/auth_api.dart' as _i39;
...
import '../../mvvm/repo/exercise_repositories.dart' as _i17;
...
import '../../mvvm/repo/repo_impl/exercise_repositories_impl.dart' as _i18;
...
import '../../mvvm/ui/wo_trac/view_model/wo_trac_view_model.dart' as _i38;
...
import 'modules/data_source_module.dart' as _i41;
...
_i1.GetIt init(
  ...
  gh.factoryParam<_i16.ExerciseOverviewViewModel, String, dynamic>((
    sessionId,
    _,
  ) =>
      _i16.ExerciseOverviewViewModel(sessionId: sessionId));
  gh.factory<_i17.ExerciseRepositories>(() => _i18.ExerciseRepositoriesImpl());
  ...
  gh.factory<_i24.PlanApi>(() => _i24.PlanApi(gh<_i14.Dio>()));
  ...
  gh.factory<_i31.SettingUseCase>(() => _i31.SettingUseCase());
  ...
  gh.factory<_i37.ViewMorePlanViewModel>(() => _i37.ViewMorePlanViewModel());
  gh.factory<_i38.WooTrackViewModel>(() => _i38.WooTrackViewModel());
  gh.factory<_i39.AuthApi>(() => _i39.AuthApi(gh<_i14.Dio>()));
  gh.factory<_i40.SettingBloc>(
      () => _i40.SettingBloc(gh<_i31.SettingUseCase>()));
  return getIt;
}

class _$DataSourceModule extends _i41.DataSourceModule {}
