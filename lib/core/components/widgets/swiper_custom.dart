...
class SwipeCustom extends StatefulWidget {
  final SwiperLayout? swipeLayout;
  final int itemCount;
  final int? duration;
  ...
  @override
  State<SwipeCustom> createState() => _SwipeCustomState();
}

class _SwipeCustomState extends State<SwipeCustom> {
  ...
  SizedBox _swiper() {
    return SizedBox(
      ...
      child: Swiper(
        ...
        layout: widget.swipeLayout ?? SwiperLayout.TINDER,
