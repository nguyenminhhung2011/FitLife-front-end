...
class S {
  ...
  String get alwayChangeItLater {
    return Intl.message(
      'Don\'t worry you can always change it later,or you can skip it for now',
      name: 'alwayChangeItLater',
      desc: '',
      args: [],
    );
  }
  ...
  String get tallDescription {
    return Intl.message(
      'Provide your height so that we can choose the most conform exercise for you.',
      name: 'tallDescription',
      desc: '',
      args: [],
    );
  }
  ...
  String get timeInWeekToExercise {
    return Intl.message(
      'How many times a week do you exercise?',
      name: 'timeInWeekToExercise',
      desc: '',
      args: [],
    );
  }
  ...
  String get durationExerciseDesc {
    return Intl.message(
      'Provide your duration so that we can choose the most conform exercise for you. ',
      name: 'durationExerciseDesc',
      desc: '',
      args: [],
    );
  }
  ...
  /// `2 - 3 days in week`
  String get twoToThereDaysInWeek {
    return Intl.message(
      '2 - 3 days in week',
      name: 'twoToThereDaysInWeek',
      desc: '',
      args: [],
    );
  }
  ...
  /// `3 - 5 days in week`
  String get three2FiveDaysInWeek {
    return Intl.message(
      '3 - 5 days in week',
      name: 'three2FiveDaysInWeek',
      desc: '',
      args: [],
    );
  }
  ...
  /// `6  - 7 days in week`
  String get six2SevenMuchOrMore {
    return Intl.message(
      '6  - 7 days in week',
      name: 'six2SevenMuchOrMore',
      desc: '',
      args: [],
    );
  }
  ...
  String get worksEveryDayOfTheWeek {
    return Intl.message(
      'Works every day of the week',
      name: 'worksEveryDayOfTheWeek',
      desc: '',
      args: [],
    );
  }
  ...
  /// `Provide your weight so that we can choose the most conform exercise for you. `
  String get weightTargetDesc {
    return Intl.message(
      'Provide your weight so that we can choose the most conform exercise for you. ',
      name: 'weightTargetDesc',
      desc: '',
      args: [],
    );
  }
